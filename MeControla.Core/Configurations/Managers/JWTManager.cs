...
namespace MeControla.Core.Configurations.Managers
{
    public class JWTManager : IJWTManager
    {
        ...
        public TokenValidationParameters GetTokenValidationParameters()
            ...
            {
                ValidateIssuerSigningKey = false,//!string.IsNullOrWhiteSpace(configuration.Secret),
                IssuerSigningKey = GetIssuerSigningKey(configuration.Secret),
                ValidateIssuer = false,//!string.IsNullOrWhiteSpace(configuration.Issuer),
                ValidateAudience = false,//!string.IsNullOrWhiteSpace(configuration.Audience),
